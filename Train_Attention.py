...
from Attention_Model import AttentionEncoder, AttentionDecoder
...
def train_attention_model(vocab_len, train_loader, val_loader):

    global best_bleu4, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, word_map

    if checkpoint is None:
        decoder = AttentionDecoder(attention_dim=attention_dim,
...
def validate(val_loader, encoder, decoder, criterion):
    ...
    with torch.no_grad():
        ...
        bleu4 = corpus_bleu(references, hypotheses, weights = (1,0,0,0))
